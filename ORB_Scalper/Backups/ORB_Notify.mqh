...
//| Inputs                                                           |
//+------------------------------------------------------------------+
input group "=== 8. Notifications (Discord / Telegram) ==="
...
input bool   ORBN_Reports_Enabled      = false;
...
input bool   ORBN_Screenshots          = false;

input group "=== 9. News Engine ==="
...
{
    if(!ORBN_Screenshots||(bool)MQLInfoInteger(MQL_TESTER)) return "";
...
{
    if(!ORBN_Reports_Enabled||(bool)MQLInfoInteger(MQL_TESTER)) return;
